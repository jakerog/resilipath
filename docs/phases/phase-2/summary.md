...
|-----------|----------------|--------|-----------------|
| [2.1 Asset Registry](2.1-assets.md) | Inventory | [x] 100% | Manage critical systems, vendors, and business impact data. |
| [2.2 Planning Engine](2.2-planning.md) | BCP Authoring | [x] 100% | Modular template system for BCP document creation. |
| [2.3 Offline Mode](2.3-offline.md) | Availability | [x] 100% | Service Worker & IndexedDB for disconnected plan access. |
| [2.4 Lifecycle Hooks](2.4-lifecycle.md) | Review Cycles | [x] 100% | Automated review reminders and version control. |
| [2.5 Advanced Exports](2.5-exports.md) | Portability | [x] 100% | DOCX and XLSX generation using serverless functions. |
| [2.6 Map View](2.6-gis.md) | Visualization | [x] 100% | Basic GIS visualization for site-wide resilience. |
